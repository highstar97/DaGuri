...
public class ProjectileSpawner : MonoBehaviourPun
{
    ...
    public GameObject SpawnProjectile(string projectilePrefabName, Vector3 position, Vector3 direction, StatComponent statComponent)
    {
        ...
        projectile.ownerStat = statComponent;
        return gameObject;
    }
    #endregion
}